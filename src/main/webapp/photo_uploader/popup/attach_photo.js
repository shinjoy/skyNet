	 ...
	 */
     function goStartMode(){
    	 ...
    	 if(sSrc.indexOf("btn_confirm2.png") < 0 ){
    		 welBtnConfirm.attr("src","/smart_editor/img/photoQuickPopup/btn_confirm2.png");
     ...
     function goReadyMode(){
    	 ...
    	 if(sSrc.indexOf("btn_confirm2.png") >= 0 ){
	    	 ...
	    	 welBtnConfirm.attr("src","/smart_editor/img/photoQuickPopup/btn_confirm.png");
    	 }
     }   
    ...
    function addImage(ofile){
		...
		if( !!bExceedLimitTotalSize ){
	        ...
	        aFileList.push('	<a onclick="delImage(\'img'+nImageInfoCnt+'\')"><img class="del_button" src="/smart_editor/img/photoQuickPopup/btn_del.png"  width="14" height="13" alt="첨부 사진 삭제"></a>');
			aFileList.push('	</li> ');   
    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/smart_file_upload.go'; 	//upload URL
    ...
    function callAjaxForHTML5_jquery (tempFile, sUploadURL){
    	alert("1 " + tempFile +", "+ sUploadURL);
		$.ajax({
			type: 'xhr',
			method : "post",
			//type:"POST",
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/smart_file_upload.go',	//샘플 URL입니다.
 	        sCallback : '/photo_uploader/popup/callback.html',	//JAVA + Spring에서는 의미 없음
 			//sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/FileUpload.php',	//샘플 URL입니다.
