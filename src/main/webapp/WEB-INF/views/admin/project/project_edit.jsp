			...
			<div class="contents-block">
				...
				<div class="contents-main">
					...
					<div class="tool-bar" style="width:800px;">
						...
						<button type="button" class="btn" style="width:100px;" onclick="document.location.href='/admin/admin/project_list.go';">목록으로</button>
					</div>
