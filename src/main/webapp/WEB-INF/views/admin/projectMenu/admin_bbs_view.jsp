...
<script type="text/javascript">
	$(document).ready(function() {
		projectMenu.AdminBbsview(pageForm,1);
	//	bbs.contextMenu();
	});
		...
		<section id="contents">
			<header class="panel">
				...
				<div class="contents-main">
					<form method="post" name="pageForm" onsubmit="return projectMenu.AdminBbsview(this,1); return false;">
						...
						<div class="comment-edit">
							...
							<input type="hidden" name="bbsCommentSeq" value="${bbsCommentSeq}">
								...
								<ul class="comment-form">
									...
									<li class="tool">
									<button type="button" onclick="adminBbs.bbsCommentedit(this.form);">전송</button>
									</li>
								</ul>
							</form>
						</div>
