...
<header>
	<ul>
		...
		<li class="top-right">
			<a href="javascript:adminBbs.showHideSearch();">
				<img src="/images/ic_search.png">
			</a>
			<c:if test="${USER_TYPE==1}">
			<a href="javascript:adminBbs.goBbsEdit(searchForm,0,'m')">
...
<article>
	...
	<form method="post" name="searchForm" onsubmit="return adminBbs.onSearch(this,1); return false;">
