...
public class Bbs {
	...
	public static int BBS_STATUS_NEW = 0;
	public static int BBS_STATUS = 1;
	public static int BBS_STATUS_ING = 2;
	public static int BBS_STATUS_DROP = 3;
	public static int BBS_STATUS_FINISH = 4;
	...
	public String getBbsStartday() {
		return bbsStartday;
	}
	public void setBbsStartday(String bbsStartday) {
		this.bbsStartday = bbsStartday;
	}
	public String getBbsEndday() {
		return bbsEndday;
	}
	public void setBbsEndday(String bbsEndday) {
		this.bbsEndday = bbsEndday;
	}
	...
	public String getStatusTxt() {
		String txt="";
		if(this.answerStatus==BBS_STATUS_NEW){
			txt="대기";
		}
	...
	public String getBbsType2Txt() {
		String txt="";
		if(this.bbsType2.equals("0")){
			txt="전체";
		}
		if(this.bbsType2.equals("1")){
			txt="내부";
		}
		return txt;
	}
