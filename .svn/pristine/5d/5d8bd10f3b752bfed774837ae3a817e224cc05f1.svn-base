...
public class MovieConverter {
	...
	private String FFMPEG_PATH = "C:/ffmpeg/ffmpeg.exe";
	
	/*
	 * ffmpegPath : ffmpeg.exe 경로
	 * fileName : 원본 파일 이름
	 * basePath : 변환 파일 경로
	 * uploadPath : 원본 파일 경로
	 */
	public MovieConverter(String ffmpegPath, String fileName, String basePath, String uploadPath) {
