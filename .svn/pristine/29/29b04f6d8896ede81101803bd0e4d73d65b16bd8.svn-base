...
<section class="main-cover main-row">
	<section id="main">
		...
		<section id="contents">
			...
			<h1><span class="top-center"></span> 공지 게시판</h1>
			<div class="contents-block">
				<div class="contents-main">
				 ...
				 <div class="btn-tools">
						<button type="button" class="btn-txt" onclick="adminBbs.bbsSave(this.form,'admin');">등록</button>
						<button type="button" class="btn-txt" onclick="link.go('/admin/admin_bbs_view.go?projectSeq=${projectSeq}&bbsSeq=${bbsSeq}&page=1');">뒤로</button>
				 </div>	
				</form>
				</div>
			</div>
