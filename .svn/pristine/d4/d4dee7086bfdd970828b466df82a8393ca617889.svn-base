	...
	initIframe : function(){
		try {
			...
			if (sCSSBaseURI){
				...
				linkNode.href = '/lib/smarteditor/smart_editor2_in.css';
...
*/		
	...
	setMainFont : function (fontId, fontName, defaultSize, fontURL, fontCSSURL, fontType) {
		...
		this.setDefaultFont(newFont.fontFamily, defaultSize, fontColor);
		
		return newFont;
	},
	
	setDefaultFont : function(sFontFamily, nFontSize, nFontColor){
		...
		elBody.style.color = nFontColor;
		//elBody.style.color = rgb(154, 154, 154);
	}
});
...
nhn.husky.SE2B_CSSLoader = jindo.$Class({
	...
	*/
	...
	loadSE2CSS : function(sMsg, oArgs){
		...
		nhn.husky.SE2M_Utils.loadCSS("/lib/smarteditor/smart_editor2_items.css", fnCallback);
